...
<section class="section-heading menu-hero-heading">
    ...
    <div class="menu-hero-visual">
        <img src="<?php echo h(app_path('Categories/Copilot_20260428_005928.png')); ?>" alt="QuickBite hero banner" loading="lazy">
    </div>
</section>

<section class="filter-row menu-filter-row">
